<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Personas.aspx.cs" Inherits="AplicacionPersonas3capas.Personas" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Capa de presentación. Uso de la clase Persona</title>
</head>
<body>
...
&nbsp;
            ...
            <tr>
                <td class="style3" colspan="2">
                    <asp:EntityDataSource ID="dsPersonas" runat="server" 
                        ConnectionString="name=DBPersonasEntities" 
                        DefaultContainerName="DBPersonasEntities" EnableFlattening="False" 
